...
Here are the notes I took from our meetings. They kind of peter at by the end, but the length of the note is inversely proportional to the amount of work I did that week.
...
o	Plots: mf = f(whp) and mf = f(time | whp)
-	Mass flow = f(WHP): Inputs: WHP, outputs: linearly declining res P to predict mass flow in future 
