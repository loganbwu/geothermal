...
```{r OLS_diagnostics, warning=FALSE, fig.cap="Diagnostic plots with all wells together."}
...
```{r presentation_plot, fig.cap="Limit comparison for three FPs with flow limits."}
sf.df2 <- sf.df %>%
