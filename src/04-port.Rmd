...
```{r verify_production_curve, fig.cap="We expect the curves to make better predictions near the PI data after inclusion. Forecasted production curves for December 1st, and shaded regions are 95% credible intervals."}
...
```{r, fig.cap="First-order autoregressive model."}
...
```{r, fig.cap="Exponentially-weighted moving average model."}
...
```{r OLS_diagnostics, warning=FALSE, fig.height=12, fig.cap="Miscellaneous regression diagnostic plots."}
